...
const RoleSpecificFormStep = ({
  ...
  const renderFormByRole = () => {
    switch (selectedRole) {
      case 'user':
        return <RegularUserForm data={data} errors={errors} onInputChange={onInputChange} />;
      case 'proveedor':
        return <ProviderForm data={data} errors={errors} onInputChange={onInputChange} />;
      case 'vendedor':
        return <SellerForm data={data} errors={errors} onInputChange={onInputChange} />;
      default:
        return (
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
