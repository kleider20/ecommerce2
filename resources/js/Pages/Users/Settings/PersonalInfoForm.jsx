...
const PersonalInfoForm = () => {
  // Estado inicial con valores por defecto (nunca null)
  const [formData, setFormData] = useState({
    document_type: 'venezolano',
    document_number: '',
    first_name: '',
    middle_name: '',
    first_surname: '',
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // ✅ Inicializar formData con valores seguros (nunca null)
        if (profileData.profile) {
          setFormData({
            document_type: profileData.profile.document_type || 'venezolano',
            document_number: profileData.profile.document_number || '',
            first_name: profileData.profile.first_name || '',
            middle_name: profileData.profile.middle_name || '',
            first_surname: profileData.profile.first_surname || '',
            second_surname: profileData.profile.second_surname || '',
            country_id: profileData.profile.country_id || '',
            state_id: profileData.profile.state_id || '',
            city: profileData.profile.city || '',
            address: profileData.profile.address || '',
            postal_code: profileData.profile.postal_code || '',
            phone: profileData.profile.phone || '',
            date_of_birth: profileData.profile.date_of_birth || '',
            gender: profileData.profile.gender || 'not_specified'
          });
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <select
            value={formData.document_type} // ✅ Siempre es string, nunca null
            onChange={(e) => handleChange('document_type', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            required
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <select
            value={formData.country_id} // ✅ Siempre es string, nunca null
            onChange={(e) => handleChange('country_id', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            required
          >
        ...
        <div>
          ...
          <select
            value={formData.state_id} // ✅ Siempre es string, nunca null
            onChange={(e) => handleChange('state_id', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            disabled={!formData.country_id}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <select
            value={formData.gender} // ✅ Siempre es string, nunca null
            onChange={(e) => handleChange('gender', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            required
          >
